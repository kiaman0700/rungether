export const KOREAN_REGIONS = [
  ...
  { level1: "광주광역시", level2: ["동구", "서구", "남구", "북구", "광산구"] },
  { level1: "대전광역시", level2: ["동구", "중구", "서구", "유성구", "대덕구"] },
  { level1: "울산광역시", level2: ["중구", "남구", "동구", "북구", "울주군"] },
  { level1: "세종특별자치시", level2: ["세종시"] },
  {
    level1: "경기도",
    level2: [
      "수원시", "용인시", "고양시", "화성시", "성남시", "부천시",
      "남양주시", "안산시", "평택시", "안양시", "시흥시", "파주시",
      "김포시", "의정부시", "광주시", "하남시", "광명시", "군포시",
      "양주시", "오산시", "이천시", "안성시", "구리시", "의왕시",
      "포천시", "양평군", "여주시", "동두천시", "과천시", "가평군",
      "연천군"
    ]
  },
  {
  ...
  { level1: "제주특별자치도", level2: ["제주시", "서귀포시"] }
] as const;

export function getLevel2Regions(level1: string): readonly string[] {
  return KOREAN_REGIONS.find((region) => region.level1 === level1)?.level2 ?? [];
}
